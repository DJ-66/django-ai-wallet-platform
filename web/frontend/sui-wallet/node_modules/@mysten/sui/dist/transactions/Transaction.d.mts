...
import * as _mysten_bcs1219 from "@mysten/bcs";
...
declare class Transaction {
  ...
  getData(): {
    ...
    expiration?: _mysten_bcs1219.EnumOutputShapeWithKeys<{
      None: true;
      Epoch: string | number;
      ValidDuring: {
    ...
    inputs: _mysten_bcs1219.EnumOutputShapeWithKeys<{
      Object: _mysten_bcs1219.EnumOutputShapeWithKeys<{
        ImmOrOwnedObject: {
          objectId: string;
          version: string | number;
          digest: string;
      ...
      FundsWithdrawal: {
        ...
        withdrawFrom: _mysten_bcs1219.EnumOutputShapeWithKeys<{
          Sender: true;
          Sponsor: true;
        }, "Sender" | "Sponsor">;
      };
    }, "Object" | "Pure" | "FundsWithdrawal" | "UnresolvedPure" | "UnresolvedObject">[];
    commands: _mysten_bcs1219.EnumOutputShapeWithKeys<{
      MoveCall: {
        package: string;
        module: string;
        function: string;
