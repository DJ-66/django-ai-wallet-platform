...
declare namespace SuiClientTypes {
  ...
  /** Query methods */
  interface TransportMethods {
    listTransactions: <Include extends TransactionInclude = {}>(options: ListTransactionsOptions<Include>) => Promise<ListTransactionsResponse<Include>>;
  ...
  type TransactionFilter = {
    /** Match transactions sent by this address. */sender: string;
    function?: never;
  } | {
    /**
   ...
   */
  type EventFilter = {
    /** Match events emitted by transactions sent by this address. */sender: string;
    emitModule?: never;
    eventType?: never;
  } | {
    /** Match events emitted by a module, specified as `package::module`. */emitModule: string;
    sender?: never;
    eventType?: never;
  } | {
    /**
  ...
  interface ListTransactionsOptions<Include extends TransactionInclude = {}> extends CoreClientMethodOptions {
  ...
  interface ListEventsOptions extends CoreClientMethodOptions {
    filter?: EventFilter;
    /**
     * Maximum number of items to return. Defaults to 50.
     *
  ...
  interface EventEntry extends Event {
    /**
  ...
  interface GetProtocolConfigOptions extends CoreClientMethodOptions {}
  interface TransportMethods {
  ...
  interface ResolveNameServiceAddressOptions extends CoreClientMethodOptions {
    name: string;
  }
  ...
  interface TransportMethods {
    resolveNameServiceAddress: (options: ResolveNameServiceAddressOptions) => Promise<ResolveNameServiceAddressResponse>;
